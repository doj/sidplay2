// --------------------------------------------------------------------------
// Advanced Linux Sound Architecture (ALSA) specific audio driver interface for QNX or old Linux.
// --------------------------------------------------------------------------
/***************************************************************************
 *  $Log: audiodrv.cpp,v $
...
void Audio_QNX_ALSA::outOfOrder ()
{
    // Reset everything.
    _errorString = "None";
    _audioHandle = NULL;
...
void *Audio_QNX_ALSA::open (AudioConfig &cfg, const char *)
{
    AudioConfig tmpCfg;
...
void *Audio_QNX_ALSA::reset ()
{
    return (void *) _sampleBuffer;
}

void *Audio_QNX_ALSA::write ()
{
    if (_audioHandle == NULL)
    {
